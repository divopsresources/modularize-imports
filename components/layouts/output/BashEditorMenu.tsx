...
const BashEditorMenu: FC<Props> = ({
  ...
  const queries = content.BashSnippets();
      ...
      <div className="space-y-6">
        ...
        <div className="mx-4 flex flex-col space-y-2">
          ...
          <div className="space-y-1">
            <Link href={`/project/${projectRef}/Bash/templates`}>
              <div>
            ...
            <div className="space-y-1">
              {favouriteQueries.map((query) => {
                ...
                return (
                  <Link
                    key={id}
                    href={`/project/${projectRef}/Bash?queryId=${id}`}
                  >
                    <div>
...
export default observer(BashEditorMenu);
